...
EXTRA_OEMAKE:append:a64 = " BL31=${DEPLOY_DIR_IMAGE}/trusted-firmware-a/bl31.bin"
...
EXTRA_OEMAKE:append:h6 = " BL31=${DEPLOY_DIR_IMAGE}/trusted-firmware-a/bl31.bin"
# We don't support the OpenRISC Crust firmware
# https://elixir.bootlin.com/u-boot/latest/source/board/sunxi/README.sunxi64#L64
EXTRA_OEMAKE:append:h6 = " SCP=/dev/null"
ATF_DEPENDS:h6 += " trusted-firmware-a:do_deploy"

EXTRA_OEMAKE:append:rk3399 = " BL31=${DEPLOY_DIR_IMAGE}/trusted-firmware-a/bl31.elf"
